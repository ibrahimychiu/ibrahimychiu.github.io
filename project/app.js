const sources = [
  ...
  },
  {
    ...
    note: "需使用司法院資料開放平台帳密換 token；服務時間與資料範圍有限制，適合後續把本 app 串成可更新資料庫。"
  },
  {
    id: "pts-2014",
...
const nodes = [
  {
    ...
    y: 360,
    r: 74,
    summary: "最高法院107年度台上字第3號判決上訴人。網絡以他為中心，展示判決代號被害人、待核對周邊協助者、司法機關與科技證據的連結。",
    tags: ["刑法第221條/225條", "妨害秘密", "偷拍影像", "應執行刑"],
    sourceStatus: "最高法院107年度台上字第3號全文已取得；原審104年度侵上更（一）字第23號附表仍需繼續補齊。"
  },
  {
    id: "victim-a",
    label: "安安",
  ...
  },
  {
    ...
    tags: ["C5", "乘機性交", "被害人陳述"],
    sourceStatus: "已由最高法院107年度台上字第3號全文建立；細節需回原審判決附表。"
  },
  {
    id: "victim-e",
    label: "恩綺",
  ...
  },
  {
    ...
    y: 104,
    r: 48,
    summary: "使用者指定要納入的周邊人物類型。現階段只作為待檢索節點，不把未核實人物具體化。",
    tags: ["接送", "移動路徑", "待裁判全文確認"],
    sourceStatus: "尚未由本次可取得的司法公開資料核實；需檢索全文關鍵字：司機、車伕、接送、送回家。"
  },
  {
    id: "broker",
    label: "仲介/介紹者",
    ...
    y: 190,
    r: 48,
    summary: "代表夜店、派對、友人介紹或媒介互動中的可能周邊角色。此節點保留為檢索欄位，不先下結論。",
    tags: ["派對連結", "友人介紹", "待裁判全文確認"],
    sourceStatus: "尚未由本次可取得的司法公開資料核實；需檢索全文關鍵字：介紹、邀約、派對、夜店、仲介。"
  },
  {
    id: "prosecutor",
    label: "檢方",
    ...
    tags: ["起訴", "舉證", "求刑", "上訴"],
    sourceStatus: "新聞資料可建立概略；起訴書與判決全文可補足逐項罪名。"
  },
  {
    id: "court",
    label: "法院",
    ...
    sourceStatus: "最高法院與憲法法庭資料已核實；中間審級需裁判書全文補齊。"
  },
  {
    id: "defense",
    label: "辯護人",
    ...
    tags: ["同意抗辯", "悔意", "上訴"],
    sourceStatus: "部分公開報導可佐證；完整需裁判書上訴意旨段落。"
  },
  {
    id: "camera",
    label: "偷拍設備/影像",
...
const edges = [
  ...
  { from: "lee", to: "driver", label: "接送路徑待核", layer: "support" },
  { from: "lee", to: "broker", label: "認識/邀約待核", layer: "support" },
...
const hoverRecords = {
  ...
  "victim-b": {
    courtCode: "原審判決代號：甲2；最高法院判決代號對照待原審附表再核",
  ...
  "victim-c": {
    courtCode: "原審判決代號：甲3；最高法院判決代號對照待原審附表再核",
    source: "臺灣高等法院104年度侵上更(一)字第23號",
  ...
  "victim-d": {
    courtCode: "原審判決代號：甲5；最高法院判決代號對照待原審附表再核",
    source: "最高法院107年度台上字第3號、原審判決待細讀",
    legal: "乘機性交；被告主張影片中有互動、有意識，法院需綜合勘驗與證述判斷。",
    snippets: [
      "判決引號索引：「舒服嗎？」",
      "判決引號索引：「怎麼了？怎麼了？」",
      "判決引號索引：「睡一下、睡一下」",
    ...
    caution: "此節點列出判決中甲5段落附近可抽得之引號對話；完整情境仍以判決全文為準。"
  },
  "victim-e": {
    courtCode: "原審判決代號：甲8；最高法院判決代號對照待原審附表再核",
    source: "臺灣高等法院104年度侵上更(一)字第23號",
  ...
  "victim-g": {
    courtCode: "原審判決代號：甲10；最高法院判決代號對照：C10",
    source: "最高法院107年度台上字第3號、原審判決待細讀",
    ...
    caution: "此節點列出判決中甲9/甲10同段附近可抽得之引號對話；具體歸屬需按判決段落上下文判讀。"
  },
  "victim-h": {
    courtCode: "原審判決代號：丙女；最高法院判決代號對照待核",
    source: "臺灣高等法院104年度侵上更(一)字第23號",
    ...
    caution: "這段和你要求的『車伕/司機』網絡節點高度相關；仍需做代號對照表。"
  },
  "victim-i": {
    courtCode: "原審判決代號：乙女或F之對照待核",
    source: "最高法院107年度台上字第3號、原審判決待細讀",
    legal: "乘機性交/妨害秘密關聯待原審附表精確對照。",
    snippets: [
      "判決引號索引：「舒服、舒服」",
      "判決引號索引：「不喜歡」",
      "判決引號索引：「NO，NO」",
    ...
    caution: "此節點列出判決中乙女/F相關段落附近可抽得之引號對話；代號對照仍需按附表逐項核對。"
  }
};
...
const events = [
  ...
  },
  {
    ...
    text: "一審就強制性交、乘機性交、妨害秘密等作成判斷。此處應回司法院裁判書查詢補入完整案號、罪名與各被害人代號。",
    source: "jud-search"
  },
  {
    date: "2014.09.02",
...
const dialogueRecords = [
  {
    ...
    status: "待原審判決附表補齊",
    text: "應從裁判書逐案抽取：誰邀約、在哪個場所、是否有人介紹、是否有司機或接送安排、被害人是否表達要離開或回家。這些資料關係到違反意願、利用不能抗拒狀態與被告認知。",
    fields: ["時間", "地點", "發話者", "接話者", "逐字/摘要", "構成要件關聯", "裁判字號與段落"]
  },
  {
    title: "意識狀態、不能抗拒與事後反應",
    linked: ["lee", "victim-a", "victim-h", "court"],
    status: "最高法院全文已建檔",
    text: "最高法院判決處理了被害人是否陷於精神、身體障礙或心智缺陷相類之無助情形，並說明事後未立即報警、驗傷或仍有聯繫，不當然可推論未遭性侵害。",
    fields: ["飲用時間", "狀態描述", "被告認知", "補強證據", "法院採信理由"]
  },
  {
    title: "影片勘驗、片段對話與反射動作",
    linked: ["lee", "camera", "victim-a", "victim-h", "defense", "court"],
    status: "最高法院全文已建檔",
    text: "判決指出，影片中可對話、解鍊、抬臀、勾頸、環抱或撫摸等片段，被告主張可推認意識正常與同意能力；法院認為只是隻言片語或性交反射動作，不能據此否定被害指證。",
    fields: ["設備", "檔案", "拍攝情境", "外流/知悉", "隱私權損害"]
  },
  {
    title: "辯方同意說與法院回應",
...
const sentencing = [
  ...
  {
    factor: "犯行數量與罪數",
    text: "最高法院判決列出C1、C2、C3、C5、C8、C9、C10、H、F等代號被害人與乘機性交、強制性交、妨害秘密等爭點；實際各罪刑需續補原審附表。",
...
const searchPlan = [
  "司法院裁判書查詢 > 裁判書查詢 > 全文內容：李宗瑞",
  "法院：最高法院；案件類別：刑事；年度：107；字別：台上；案號：3",
  "法院：臺灣高等法院；案件類別：刑事；全文：李宗瑞 妨害性自主 侵上更",
  "全文關鍵字：司機、車伕、接送、介紹、邀約、夜店、偷拍、不能抗拒、同意",
  "民事裁判全文：李宗瑞 H女、C1、C9、隱私權、貞操權、損害賠償"
];
...
function renderProfile(node) {
  ...
  return `
    <div class="detail-title">
      ...
      <span class="status-pill">${node.sourceStatus.includes("待") || node.sourceStatus.includes("尚未") ? "待核對" : "已建檔"}</span>
    </div>
...
function renderSources() {
  return `
    <div class="record">
      <h3>司法院檢索策略</h3>
      <p>這一版把資料欄位設計好，但不偽造尚未取得的判決全文細節。下一步應用下列條件逐案檢索，把裁判書段落貼回資料表。</p>
